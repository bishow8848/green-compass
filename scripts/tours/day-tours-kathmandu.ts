...
export const foodTour: Tour = {
  ...
  content: {
    ...
    faqs: VALLEY_FAQS,
    inclusions: {
      transport: ["Private vehicle for hotel pickup and drop-off within central Kathmandu; the tour itself is on foot."],
    ...
    inExDescription: "Private vehicle transfers, all tastings and drinks on the route and a local food guide are included, while extra dishes, alcohol and tips are excluded.",
    bestTime: "Oct-Apr",
    meta: {
...
export const everestMountainFlight: Tour = {
  ...
  content: {
    ...
    inclusions: {
      ...
      transport: ["Private vehicle transfer between your hotel and the domestic terminal."],
    ...
    inExDescription: "Private vehicle transfers, the mountain flight with a guaranteed window seat, airport charges and a mountain chart are included, while meals, insurance and weather-cancellation costs are excluded.",
    bestTime: "Oct-Mar",
    meta: {
